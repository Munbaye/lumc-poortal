<x-filament-panels::page>
    ...
    @if($visit && $visit->patient)
        ...
        <div class="chart-tabs">
            ...
            <button wire:click="setTab('vitals')" class="chart-tab {{ $activeTab==='vitals'    ? 'active':'' }}"><span class="tab-icon"><x-heroicon-o-heart class="w-4 h-4" /></span> Vital Signs @if($allVitals->count() > 0)<span class="tab-badge tab-badge-warn">{{ $allVitals->count() }}</span>@endif</button>
