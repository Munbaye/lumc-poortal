...
<style>
.ph-header { background:linear-gradient(135deg,#1e3a5f,#2563eb); border-radius:10px; padding:16px 22px; margin-bottom:20px; display:flex; align-items:center; justify-content:space-between; flex-wrap:wrap; gap:12px; }
...
.ph-pill { background:rgba(255,255,255,.15); border:1px solid rgba(255,255,255,.22); border-radius:6px; padding:4px 12px; font-size:.78rem; color:#e0f2fe; font-weight:600; }
...
.vt-wrap { background:#fff; border:1px solid #e5e7eb; border-radius:10px; overflow-x:auto; -webkit-overflow-scrolling:touch; }
.dark .vt-wrap { background:#1f2937; border-color:#374151; }
.vt-table { width:100%; min-width:720px; border-collapse:collapse; font-size:.855rem; }
.vt-table thead tr { background:#f9fafb; border-bottom:1px solid #e5e7eb; }
.dark .vt-table thead tr { background:#111827; border-bottom-color:#374151; }
.vt-table th { padding:10px 12px; text-align:left; font-size:.68rem; font-weight:700; text-transform:uppercase; letter-spacing:.06em; color:#6b7280; white-space:nowrap; }
.vt-table td { padding:12px 12px; border-bottom:1px solid #f3f4f6; vertical-align:middle; }
...
.dark .vt-table tbody tr:hover td { background:rgba(37,99,235,.07); }
...
.vt-table tbody tr:hover .row-arrow { color:#2563eb; }
.current-row td { background:#fffbeb !important; }
.current-badge { font-size:.62rem; font-weight:700; background:#fef3c7; color:#92400e; padding:1px 6px; border-radius:9999px; display:block; margin-top:2px; }
...
<a href="{{ $this->getPatientListUrl() }}" class="btn-back">← Back to Patient List</a>
...
<div class="stats-bar">
    <div class="stat-card"><p class="stat-label">Total Visits</p><p class="stat-value">{{ $totalVisits }}</p></div>
    <div class="stat-card"><p class="stat-label">ER Visits</p><p class="stat-value" style="color:#991b1b;">{{ $erVisits }}</p></div>
    <div class="stat-card"><p class="stat-label">OPD Visits</p><p class="stat-value" style="color:#1d4ed8;">{{ $opdVisits }}</p></div>
    <div class="stat-card"><p class="stat-label">Admissions</p><p class="stat-value" style="color:#065f46;">{{ $admissions }}</p></div>
</div>
