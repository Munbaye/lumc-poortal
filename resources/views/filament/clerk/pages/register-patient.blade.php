<x-filament-panels::page>
    ...
    <div style="background:#fff;border:2px solid #dc2626;border-radius:12px;padding:24px;margin-bottom:20px;">
        ...
        <div style="margin-bottom:16px;">
            <label class="lumc-label {{ $errors->has('unknownFormData.chief_complaint') ? 'lumc-label-error' : '' }}">Chief Complaint / Reason for ER Visit <span class="lumc-required">*</span></label>
            ...
            @error('unknownFormData.chief_complaint')<p class="lumc-error">{{ $message }}</p>@enderror
        </div>
    ...
    <div class="lumc-section">
        ...
        <div style="display:grid;grid-template-columns:repeat(5,1fr);gap:12px;margin-bottom:16px;">
            <div>
                <label class="lumc-label">Family Name <span class="lumc-required">*</span></label>
        ...
        <div style="background:#fefce8;border:1px solid #fde047;border-radius:10px;padding:16px;">
            <p style="font-weight:700;color:#854d0e;margin:0 0 4px;">No similar patients found for "<strong>{{ $searchFamilyName }}</strong>"</p>
        ...
        <div style="text-align:center;padding:40px 0;color:#9ca3af;">
            <div style="margin:0 0 8px;display:flex;justify-content:center;">
                <x-filament::icon icon="heroicon-o-magnifying-glass" class="w-8 h-8 text-gray-400" />
            </div>
    ...
    <div class="lumc-section">
        ...
        <div style="display:grid;grid-template-columns:repeat(3,1fr);gap:16px;margin-bottom:20px;">
            <div>
                <label class="lumc-label {{ $errors->has('formData.family_name') ? 'lumc-label-error' : '' }}">Family Name <span class="lumc-required">*</span></label>
                <input type="text" wire:model="formData.family_name"
                    autocomplete="off" autocorrect="off" autocapitalize="off" spellcheck="false"
                    class="lumc-input {{ $errors->has('formData.family_name') ? 'lumc-input-error' : '' }}">
                @error('formData.family_name')<p class="lumc-error">{{ $message }}</p>@enderror
            </div>
            <div>
                <label class="lumc-label {{ $errors->has('formData.first_name') ? 'lumc-label-error' : '' }}">First Name <span class="lumc-required">*</span></label>
                <input type="text" wire:model="formData.first_name"
                    autocomplete="off" autocorrect="off" autocapitalize="off" spellcheck="false"
                    class="lumc-input {{ $errors->has('formData.first_name') ? 'lumc-input-error' : '' }}">
                @error('formData.first_name')<p class="lumc-error">{{ $message }}</p>@enderror
            </div>
            <div>
            ...
            <div>
                <label class="lumc-label {{ $errors->has('formData.sex') ? 'lumc-label-error' : '' }}">Sex <span class="lumc-required">*</span></label>
                ...
                @error('formData.sex')<p class="lumc-error">{{ $message }}</p>@enderror
            </div>
            <div>
            ...
            {{-- Address --}}
            <div style="margin-bottom:20px;">
                <label class="lumc-label {{ $errors->has('formData.address') ? 'lumc-label-error' : '' }}">Complete Address <span class="lumc-required">*</span></label>
                <input type="text" wire:model="formData.address" placeholder="e.g., Brgy. Poblacion, Agoo, La Union"
                    class="lumc-input {{ $errors->has('formData.address') ? 'lumc-input-error' : '' }}">
                @error('formData.address')<p class="lumc-error">{{ $message }}</p>@enderror
            </div>
        </div>
        ...
        <div style="display:grid;grid-template-columns:repeat(2,2fr);gap:16px;margin-bottom:20px;">
            <div>
        ...
        {{-- Chief Complaint --}}
        <div style="margin-bottom:20px;">
            <label class="lumc-label {{ $errors->has('formData.chief_complaint') ? 'lumc-label-error' : '' }}">Chief Complaint <span class="lumc-required">*</span></label>
            <textarea wire:model="formData.chief_complaint" rows="2"
                ...
                style="resize:vertical;"></textarea>
            @error('formData.chief_complaint')<p class="lumc-error">{{ $message }}</p>@enderror
        </div>
        ...
        <div style="background:#fef2f2;border:2px solid #fca5a5;border-radius:10px;padding:16px;margin-bottom:24px;">
            <div style="display:flex;align-items:flex-start;gap:10px;">
                ...
                <div>
                    <label for="hasIncompleteInfo" style="font-size:.85rem;font-weight:700;cursor:pointer;color:#dc2626;display:block;margin-bottom:3px;">Patient has missing or incomplete information</label>
