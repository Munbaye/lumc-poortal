        ...
        @foreach($pending as $visit)
            ...
            <div class="adm-card dark:bg-gray-900 dark:border-gray-700">
                ...
                <div style="flex-shrink:0;text-align:right;">
                    <a href="{{ \App\Filament\Clerk\Pages\CompleteAdmission::getUrl(['visitId' => $visit->id]) }}" style="display:inline-block;background:#059669;color:#fff;padding:10px 22px;
                          border-radius:8px;font-size:.85rem;font-weight:700;
                          text-decoration:none;white-space:nowrap;" onmouseover="this.style.background='#047857'"
