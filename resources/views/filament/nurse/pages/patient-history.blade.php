...
<style>
.ph-header { background:linear-gradient(135deg,#881337,#f43f5e); border-radius:10px; padding:16px 22px; margin-bottom:20px; display:flex; align-items:center; justify-content:space-between; flex-wrap:wrap; gap:12px; }
...
.vt-table tbody tr:hover td { background:#fff1f2; }
.dark .vt-table tbody tr:hover td { background:rgba(244,63,94,.07); }
...
.vt-table tbody tr:hover .row-arrow { color:#f43f5e; }
...
<div style="text-align:center;padding:60px 20px;">
    ...
    <a href="{{ $this->getPatientListUrl() }}" style="color:#f43f5e;font-size:.875rem;">← Back</a>
</div>
@endif
