    ...
    <style>
        * {
        ...
        .hov-card:hover {
            ...
            box-shadow: 0 20px 40px rgba(26, 58, 138, .12);
        }
        ...
        .hdr-scrolled {
            box-shadow: 0 4px 24px rgba(26, 58, 138, .13) !important;
        }
...
<body class="bg-gray-50 text-gray-800">
        ...
        <div class="patient-modal">
            ...
            <div class="modal-body">
                ...
                <div id="modalChangePassword" style="display:none;">
                    <div class="modal-head">
                        <div class="modal-head-left"><img src="{{ asset('images/lumc-logo.png') }}" alt="LUMC" class="modal-head-logo" onerror="this.style.display='none'">
                            <div>
                                <div class="modal-head-super">La Union Medical Center</div>
    ...
    <script>
        ...
        function handleOverlayClick(e) {
            if (document.getElementById('modalChangePassword').style.display !== 'none') return;
            if (e.target === document.getElementById('loginModal')) closeLoginModal();
        }
        document.addEventListener('keydown', e => {
            if (e.key === 'Escape' && document.getElementById('modalChangePassword').style.display === 'none') closeLoginModal();
        });
        ...
        var obs = new IntersectionObserver(function(e) {
            e.forEach(function(v) {
                if (v.isIntersecting) v.target.classList.add('in');
            });
        }, {
            threshold: .1
        });
        ...
        (function() {
            var D = 5000,
                c = document.querySelector('.hero-carousel');
            if (!c) return;
            var s = Array.from(c.querySelectorAll('.carousel-slide')).filter(function(x) {
