...
<body>
    ...
    <div class="paper">
        ...
        <div class="g4" style="margin-bottom:7px;">
            <div class="fg"><span class="fl">Date</span><input type="date" id="f_date" class="fi"
                    value="{{ $today ?? '' }}"></div>
            <div class="fg"><span class="fl">RAD File No.</span><input type="text" id="f_rad_file" class="fi"
                    value="{{ $requestNo }}" style="font-family:monospace;font-weight:bold;"></div>
            <div class="fg"><span class="fl">Hospital No. (Case No.)</span><input type="text" id="f_hospital_no"
                    class="fi" value="{{ $hospitalNo ?? '' }}"></div>
            <div class="fg"><span class="fl">Service / Ward</span><input type="text" id="f_ward" class="fi"
                    value="{{ $ward ?? '' }}"></div>
        </div>
        ...
        <div class="g3" style="margin-bottom:7px;">
            <div class="fg"><span class="fl">Family Name</span><input type="text" id="f_family" class="fi"
                    value="{{ $familyName ?? '' }}"></div>
            <div class="fg"><span class="fl">Given Name</span><input type="text" id="f_first" class="fi"
                    value="{{ $firstName ?? '' }}"></div>
        ...
        <div style="display:grid;grid-template-columns:2fr 1fr 1fr 1fr;gap:10px;margin-bottom:8px;">
            <div class="fg"><span class="fl">Address</span><input type="text" id="f_address" class="fi"
                    value="{{ $address ?? '' }}"></div>
            <div class="fg"><span class="fl">Date of Birth</span><input type="date" id="f_dob" class="fi"
        ...
        <div class="fg" style="margin-bottom:7px;"><span class="fl">Examination Desired</span><textarea id="f_exam"
                rows="3" class="area"
                placeholder="Specify exam — e.g., Chest X-Ray PA, Whole Abdomen Ultrasound, CT Brain non-contrast…"></textarea>
        </div>
        <div class="fg" style="margin-bottom:7px;"><span class="fl">Clinical Diagnosis</span><textarea id="f_clin_diag"
                rows="2" class="area">{{ $clinicalDiagnosis ?? '' }}</textarea></div>
        <div class="fg" style="margin-bottom:9px;"><span class="fl">Pertinent / Brief Clinical Findings</span><textarea
                id="f_findings" rows="3" class="area"
                placeholder="Relevant history, symptoms, and clinical findings…"></textarea></div>
