...
<head>
    ...
    <style>
        ...
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        @media screen { body { padding: 52px 0 56px; } .paper { width: 8.5in; min-height: 14in; margin: 0 auto; background: #fff; box-shadow: 0 4px 28px rgba(0,0,0,.28); padding: 0.45in 0.55in; } }
        @media print { body { background: #fff; padding: 0; } .paper { width: 100%; padding: 0; box-shadow: none; } .no-print { display: none !important; } input, select { background: transparent !important; outline: none !important; -webkit-print-color-adjust: exact; } input[type="radio"] { print-color-adjust: exact; -webkit-print-color-adjust: exact; } .test-item.checked .cb { background: #000 !important; print-color-adjust: exact; } }
        ...
        .fi-ro { width: 100%; border: none; border-bottom: 1px solid #888; padding: 1px 2px; background: transparent; font-family: inherit; color: #000; font-size: 9.5pt; display: block; min-height: 18px; cursor: default; user-select: none; }
...
<div class="paper">
    ...
    <div class="screen-tip no-print">
        💡 <strong>Click test names</strong> to select. Click <strong>Submit Request</strong> to save, then <strong>Print / PDF</strong> for the hardcopy.
    </div>
    ...
    <div class="tests-grid">
        <div style="display:flex;flex-direction:column;gap:5px;">
            <div class="test-section"><div class="test-sec-head" style="background:#dbeafe;color:#1e40af;"><span class="test-sec-dot" style="background:#3b82f6;"></span>Hematology</div><div id="sec-hema"></div></div>
            <div class="test-section"><div class="test-sec-head" style="background:#f3f4f6;color:#374151;"><span class="test-sec-dot" style="background:#6b7280;"></span>Blood Typing</div>
            ...
            <div class="test-section"><div class="test-sec-head" style="background:#ede9fe;color:#5b21b6;"><span class="test-sec-dot" style="background:#8b5cf6;"></span>Serology</div><div id="sec-serology"></div></div>
        </div>
        <div style="display:flex;flex-direction:column;gap:5px;">
            <div class="test-section"><div class="test-sec-head" style="background:#dcfce7;color:#166534;"><span class="test-sec-dot" style="background:#22c55e;"></span>Clinical Chemistry</div><div id="sec-chem"></div></div>
            <div class="test-section"><div class="test-sec-head" style="background:#fee2e2;color:#991b1b;"><span class="test-sec-dot" style="background:#ef4444;"></span>Lipid Profile</div><div id="sec-lipid"></div></div>
            <div class="test-section"><div class="test-sec-head" style="background:#fce7f3;color:#9d174d;"><span class="test-sec-dot" style="background:#ec4899;"></span>Serum Electrolytes</div><div id="sec-electro"></div></div>
            <div class="test-section"><div class="test-sec-head" style="background:#e0f2fe;color:#0c4a6e;"><span class="test-sec-dot" style="background:#0ea5e9;"></span>Renal Profile</div><div id="sec-renal"></div></div>
            <div class="test-section"><div class="test-sec-head" style="background:#d1fae5;color:#065f46;"><span class="test-sec-dot" style="background:#10b981;"></span>HBT Profile</div><div id="sec-hbt"></div></div>
        </div>
        <div style="display:flex;flex-direction:column;gap:5px;">
            <div class="test-section"><div class="test-sec-head" style="background:#fef9c3;color:#854d0e;"><span class="test-sec-dot" style="background:#eab308;"></span>Clinical Microscopy</div><div id="sec-micro"></div></div>
            <div class="test-section">
                ...
                <div id="sec-mbio"></div>
                <div class="micro-extra"><span style="font-size:7pt;color:#888;text-transform:uppercase;letter-spacing:.04em;">Specimen</span><input type="text" id="f_specimen" class="micro-fi" placeholder="Specimen type"></div>
                <div class="micro-extra"><span style="font-size:7pt;color:#888;text-transform:uppercase;letter-spacing:.04em;">Antibiotics / Duration</span><input type="text" id="f_antibiotics" class="micro-fi" placeholder="Antibiotic name · duration"></div>
            </div>
            <div class="test-section">
                ...
                <div style="padding:5px 7px;"><textarea id="f_others" style="width:100%;border:1px solid #e5e7eb;border-radius:3px;font-size:8pt;padding:3px 5px;resize:none;height:48px;outline:none;font-family:inherit;" placeholder="Other tests / remarks…"></textarea></div>
            </div>
        </div>
    </div>
    ...
    <div style="display:grid;grid-template-columns:1fr 1fr;gap:30px;margin-top:6px;">
        <div><div class="sig-line" style="margin-top:20px;"></div><div class="sig-cap">Requesting Physician — Signature / PRC No.</div></div>
        <div style="display:flex;flex-direction:column;justify-content:flex-end;"><div class="sig-line" style="margin-top:20px;"></div><div class="sig-cap">Verified by (Lab Staff) / Date</div></div>
    </div>
